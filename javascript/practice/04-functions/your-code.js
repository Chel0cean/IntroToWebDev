...
function addTwoNumbers(x, y) {
 return (x + y) // your code goes here
}
...
console.log("max =====");
console.log("max(-1, 0, 1) -> expected: 1, actual: %s", Grt(-1, 0, 1));
console.log("max(11, 2, 1) -> expected: 11, actual: %s", Grt(11, 2, 1));
console.log("max(-15.67, 33.293, 0.51) -> expected: 33.293, actual: %s", Grt(-15.67, 33.293, 0.51));
console.log("max(4, 987654321, 0) -> expected: 987654321, actual: %s", Grt(4, 987654321, 0));
